...
export function PlanScreen() {
  ...
  }, [currentPlan, generatePlan, tasks]);
  ...
  function handleMakeLighter() {
    ...
    generatePlan(lightTasks.length > 0 ? lightTasks : tasks);
  }
      ...
      {!plan || plan.items.length === 0 ? (
        <section className="rounded-[28px] border border-[#E5E7EB] bg-white p-6 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-[#6B7280]">
            Add some flexible tasks first, then I can build a calm plan for your
            day.
          </p>
        ...
        <>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-[17px] font-semibold leading-6">
                      {item.title}
                    </h2>
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  <button
                    type="button"
                    className="rounded-2xl bg-[#4F8DFD] px-3 py-3 text-sm font-semibold text-white"
                  >
                    Start
                  </button>
          ...
          <section className="mt-5 grid gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-2xl border border-[#E5E7EB] bg-white px-5 py-4 text-[15px] font-semibold text-[#1F2937] shadow-sm"
            >
              <Wand2 size={18} />
              Make it lighter
            </button>
