...
export function ProgressScreen() {
  ...
  const mainWinText =
    stats.completedTasks > 0
      ? "You completed something today."
      : stats.startedTasks > 0
        ? "You started. That already counts."
        : "One small start is enough for today.";
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold">
                {stats.points} gentle points
              </h2>
              <p className="mt-1 text-sm leading-6 text-[#6B7280]">
                Earned from starting, focusing, and finishing.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-5 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#6B7280]">
              A soft view of your focus minutes.
            </p>
          </div>
        </div>
          ...
          {stats.weeklyMinutes.map((item) => {
            ...
            return (
              <div key={item.day} className="flex flex-1 flex-col items-center">
                <div className="flex h-24 w-full items-end rounded-full bg-[#F8FAFC]">
                  <div
        ...
        {badges.length === 0 ? (
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            {badges.map((badge) => (
              <div
                key={badge.title}
                className="min-w-[140px] rounded-2xl border border-[#E5E7EB] bg-[#F8FAFC] p-4"
              >
      ...
      <section className="mt-5 rounded-[28px] border border-[#E5E7EB] bg-white p-5 shadow-sm">
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-[#6B7280]">
              You start more easily when the first step is small. I can keep
              your next plan lighter.
            </p>
          </div>
        </div>
